...
class Motors {
  ...
  using Extremes = std::pair<std::atomic<std::optional<int_fast16_t>>,
  ...
  std::atomic<bool> m_captureFilm;
  std::atomic<bool> m_movementSmooth;
...
private:
  ...
  void resetValues(std::atomic<std::optional<int_fast16_t>> &value1,
                   std::atomic<std::optional<int_fast16_t>> &value2);
  void resetStep();
  void setValue(std::atomic<std::optional<int_fast16_t>> &ref,
                int_fast16_t newValue);
  void setValues(std::atomic<std::optional<int_fast16_t>> &ref1,
  ...
  void movementModeHandler(AsyncWebSocketClient *client, const String &msg);
  void captureModeHandler(AsyncWebSocketClient *client, const String &msg);
